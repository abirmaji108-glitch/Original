    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 scroll-smooth">
      ...
      <section className="container mx-auto px-6 pt-20 pb-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto">
            Just describe your vision. Our AI generates professional, responsive websites instantly. No coding required. No design skills needed.
          </p>
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            ...
            <Button size="lg" variant="outline" onClick={() => window.location.href = '/#/login'} className="text-lg px-8 py-6 h-auto border-2">
              Watch Demo
            </Button>
          </div>
          {/* Trust Indicators */}
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* ... (all feature cards remain exactly as in original) */}
            {/* Feature cards omitted for brevity – they are unchanged */}
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          {/* Testimonials Grid & Trust indicators – unchanged */}
          {/* ... */}
        </div>
      </section>
